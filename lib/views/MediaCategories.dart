...
import 'package:project_praktikum/views/NewsCategories.dart';
...
class MediaCategories extends StatefulWidget {
  ...
  MediaCategories({Key? key});

  @override
  _MediaCategories createState() => _MediaCategories();
}

class _MediaCategories extends State<MediaCategories> {
